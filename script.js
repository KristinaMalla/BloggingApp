...
const loadData = () => {
	...
	// converting stringified-object to object
	const {
		cards
	} = JSON.parse(getInitialData);

	// mapping around the array to generate HTML card and inject it to DOM
...
// creating a function which will trigerred on clicking on save changes in the modal
const saveChanges = () => {
	const blogData = {
	...
	updateLocalStorage()
	// providing some unique identification, i.e key, here key is "blog", 
